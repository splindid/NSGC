...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        # 迷你数据集配置 (用于测试和调试)
        "VG_mini_with_attribute": {
            "img_dir": "vg/VG_100K",
            "roidb_file": "vg_mini/VG-SGG-with-attri.h5",
            "dict_file": "vg_mini/VG-SGG-dicts-with-attri.json",
            "image_file": "vg/image_data.json",
        },
        # ========== GQA 数据集配置 ==========
        # GQA 完整数据集
        "GQA_200k": {
            "img_dir": "gqa/images",
            "scenegraphs_file": "gqa/train_sceneGraphs.json",
            "dict_file": "gqa/GQA-SGG-dicts.json",
        },
        # GQA 迷你数据集 (100张图片，用于测试)
        "GQA_mini": {
            "img_dir": "gqa/images",
            "scenegraphs_file": "gqa/mini_sceneGraphs_1000.json",
            "dict_file": "gqa/GQA-SGG-dicts.json",
        },
    }
    ...
    def get(name, cfg):
        if "coco" in name:
            ...
            # name should be something like VG_stanford_filtered_train or GQA_mini_train
            p = name.rfind("_")
