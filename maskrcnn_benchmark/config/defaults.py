...
# 后处理相关配置
_C.MODEL.ROI_RELATION_HEAD.CAUSAL.REPROCESS = False  # 是否启用后处理
_C.MODEL.ROI_RELATION_HEAD.CAUSAL.JiLVpath = 'statistics'  # 统计数据保存路径
_C.MODEL.ROI_RELATION_HEAD.CAUSAL.JiLV = False  # 统计数据收集标志
...
# Random seed for reproducibility (-1 means no seed)
_C.SEED = -1
